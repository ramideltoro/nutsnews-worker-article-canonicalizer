...
Image: `ghcr.io/ramideltoro/nutsnews-worker-article-canonicalizer:<commit-sha>`

The publish workflow validates, signs, and pushes immutable SHA-tagged images. It does not publish mutable `latest` tags.
